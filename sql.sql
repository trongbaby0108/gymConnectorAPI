...
-- ----------------------------
BEGIN;
INSERT INTO `bill_pt` (`bill_pt_id`, `day_end`, `day_start`, `pt_id`, `user_id`) VALUES (1, '2022-12-14 13:15:31', '2022-11-14 13:15:31', 1, 1), (2, '2022-12-15 14:04:11', '2022-11-15 14:04:11', 1, 3);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `combo` (`combo_id`, `enable`, `name`, `price`, `gym_id`) VALUES (1, b'1', 'gold', 1000000, 1), (2, b'1', 'silver', 500000, 1), (3, b'1', 'dimond', 1500000, 1), (4, b'1', 'dimond', 1500000, 2), (5, b'1', 'gold', 1000000, 2), (6, b'1', 'silver', 500000, 2), (7, b'1', 'silver', 500000, 3), (8, b'1', 'gold', 1000000, 3);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gym` (`gym_id`, `address`, `avatar`, `email`, `enable`, `name`, `phone`) VALUES (1, 'TP.HCM', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668223011/ppf0ynwgbic2qlwtf7ap.jpg', 'demo@gmail.com', b'1', 'demo1', '123123'), (2, 'TP.HCM', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668223005/bqnttqv3sjljfohjtd3y.jpg', 'demo@gmail.com', b'1', 'demo2', '123123'), (3, 'TP.HCM', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668223005/bqnttqv3sjljfohjtd3y.jpg', 'demo@gmail.com', b'1', 'demo3', '123123');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gym_rate` (`gym_rate_id`, `content`, `vote`, `gym_id`, `user_id`) VALUES (1, 'tốt', 5, 1, 1), (2, 'đéo tốt', 1, 1, 1), (3, 'good', 5, 1, 1), (4, 'nhu qq', 5, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `personal_trainer` (`pt_id`, `address`, `avatar`, `name`, `price`, `account_id`, `gym_id`) VALUES (1, 'hcm', 'https://res.cloudinary.com/dzjmvy2ty/image/upload/v1668350835/gymer_iwe6ot.png', 'văn tèo', 10000000, 3, 1), (2, 'hcm', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668413345/xvnk1vvtovcubdyjedv9.png', 'văn tí', 10000000, 13, 1), (3, 'hcm', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668413996/pebfspfbjmc7xt7mausc.png', 'bi', 10000000, 14, 1), (4, 'hcm', 'http://res.cloudinary.com/dzjmvy2ty/image/upload/v1668414272/hbvim71imdho1xyspw4m.png', 'ptkhang', 10000000, 15, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pt_rate` (`pt_rate_id`, `comment`, `vote`, `pt_id`, `user_id`) VALUES (1, 'tốt', 5, 1, 1), (2, 'good', 4, 1, 1), (3, '10d', 4.5, 1, 1), (4, 'good vl', 4.5, 1, 1), (5, 'cung~ dc', 5, 1, 1), (6, 'goood', 5, 2, 3);
COMMIT;
